                ...
                children: [
                  CircleAvatar(
                    backgroundImage: NetworkImage(
                        "https://images.pexels.com/photos/1191488/pexels-photo-1191488.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"),
                  ),
                  SizedBox(
                    width: 15.0,
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Loremp imsum Loremp imsump loremp impsum loremp loremp impsum loremp",
                          maxLines: 2,
                        )
                      ],
                    ),
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(child: Text("Loremp imnsump dolor im sama")),
                      Container(
                        child: Row(
                          children: [
                            Text("On"),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Loremp imnsump dolor im sama"),
                      Container(
                        child: Row(
                          children: [
                            Text("Off"),
